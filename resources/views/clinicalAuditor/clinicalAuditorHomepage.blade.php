  ...
  <div>
    <div class="wellcome" >
      ...
      <div style='float:left;'>
        <input type="checkbox" class='toggle' name='' id='check'>
          <!-- <img src="../assets/logo.jpg"  width="50px" alt="logo is no available" /> -->
            ...
            <li>  <a href="{{ url('/viewGratitudeClinics') }}" class="{{'viewgratitudeclinics'==request()->path()? 'active':''}}">View Gratitude clinics</a></li>
     ...
     <div class='navAndMain'>
              <div class='topNav'><h3>{{__('field.clinicalAuditorHeader')}}</h3>
