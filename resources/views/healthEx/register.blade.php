            ...
            <div class="container">
                ...
                <div>
                    ...
                    <label> Member ID </label><br>
                        ...
                        <input type="text" name="mName" placeholder="Middlename" size="15" required /> <br>
                        ...
                        <input type="text" name="status" placeholder="renewal status of member" size="10" required><br>
